...
let uranus = { X = 12.89436956; Y = -15.1111514; Z = -0.2233075789; VX = 0.002964601376 * daysPerYear; VY = 0.00237847174 * daysPerYear; VZ = -2.965895685e-05 * daysPerYear; Mass = 4.366244043e-05 * solarMass }

let neptune = { X = 15.37969711; Y = -25.91931461; Z = 0.179258773; VX = 0.002680677725 * daysPerYear; VY = 0.0016282417 * daysPerYear; VZ = -9.515922545e-05 * daysPerYear; Mass = 5.15138902e-05 * solarMass }

let sun = { X = 0.0; Y = 0.0; Z = 0.0; VX = 0.0; VY = 0.0; VZ = 0.0; Mass = solarMass }
