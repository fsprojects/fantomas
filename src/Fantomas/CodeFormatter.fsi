...
type CodeFormatter =
    ...
    static member Parse : fileName:string * source:string -> ParsedInput array
    /// Parse a source string using given config
    static member ParseAsync : fileName:string * source:string * projectOptions:FSharpParsingOptions * checker:FSharpChecker -> Async<ParsedInput array> 
